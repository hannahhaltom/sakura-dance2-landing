...
export default function Index() {
  ...
  return (
    <div className="min-h-screen overflow-x-hidden font-body">
      ...
      {/* ── NAV ── */}
      <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-8 py-4 backdrop-blur-md bg-sakura-dark/80 border-b border-sakura-petal/10">
        <div className="flex items-center gap-2">
          <span className="font-display text-xl font-light tracking-[0.25em] text-sakura-petal">HONMA</span>
        </div>
        <div className="hidden md:flex items-center gap-8 text-xs tracking-[0.2em] text-sakura-petal/70 font-light uppercase">
          <a href="#story" className="hover:text-sakura-petal transition-colors">Story</a>
          <a href="#performance" className="hover:text-sakura-petal transition-colors">Performance</a>
          <a href="#whats-included" className="hover:text-sakura-petal transition-colors">Included</a>
          <a href="#colors" className="hover:text-sakura-petal transition-colors">Colors</a>
        </div>
        <a
          href="https://us.honmagolf.com/collections/sakura-dance-2-package-sets"
          target="_blank"
          rel="noopener noreferrer"
          className="text-xs tracking-[0.2em] uppercase font-light px-5 py-2 border border-sakura-petal/60 text-sakura-petal hover:bg-sakura-petal hover:text-sakura-dark transition-all duration-300"
        >
          Shop Now
        </a>
      </nav>
      ...
      >
        ...
        <div className="absolute inset-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-r from-sakura-dark/95 via-sakura-dark/70 to-transparent" />
        </div>

        {/* Hero content */}
        <div className="relative z-10 max-w-7xl mx-auto px-8 pt-24 pb-16 grid md:grid-cols-2 items-center gap-16">
          <div>
            <p className="animate-fade-up delay-100 text-xs tracking-[0.4em] uppercase text-sakura-petal/70 mb-4 font-light">
              Honma Golf · Limited Edition
            </p>
            <h1 className="animate-fade-up delay-200 font-display text-6xl md:text-8xl font-light leading-[1.05] text-sakura-petal mb-2">
              Sakura
            </h1>
            <h1 className="animate-fade-up delay-300 font-display text-6xl md:text-8xl font-light leading-[1.05] shimmer-text mb-8">
              Dance 2
            </h1>
            <p className="animate-fade-up delay-400 text-sakura-petal/65 text-base md:text-lg leading-relaxed mb-10 max-w-md font-light">
            ...
            <div className="animate-fade-up delay-500 flex flex-col sm:flex-row gap-4 items-start">
              ...
              <a
                href="#story"
                className="inline-block px-10 py-3.5 border border-sakura-petal/40 text-sakura-petal text-xs tracking-[0.25em] uppercase font-light hover:border-sakura-petal transition-colors"
              >
                Discover More
              </a>
            </div>
            <p className="animate-fade-up delay-600 mt-6 text-xs tracking-widest text-sakura-petal/40 uppercase">
        ...
        {/* Scroll indicator */}
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 text-sakura-petal/40">
          <span className="text-[10px] tracking-[0.3em] uppercase font-light">Scroll</span>
          <div className="w-px h-10 bg-gradient-to-b from-sakura-petal/40 to-transparent animate-pulse" />
        </div>
      </section>
